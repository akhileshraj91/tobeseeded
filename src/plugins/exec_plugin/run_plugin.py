"""
This script is called by the plugin-wrapper, exec_plugin.js, which passes down the
...
from exec_plugin import exec_plugin
...
plugin = exec_plugin(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
